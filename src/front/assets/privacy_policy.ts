...
1. SNS(카카오, 구글) 로그인으로 회원가입 및 관리: 닉네임, 이메일(카카오 제외)

4. 개인정보의 파기 절차 및 방법
① <개인정보처리자명>은(는) 개인정보 홈페이지 탈퇴로 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
...
권리 행사는 <개인정보처리자명>에 대해 「개인정보 보호법」 시행령 제41조 제1항에 따라 서면, 전자우편 등을 통하여 하실 수 있으며, <개인정보처리자명>은(는) 이에 대해 지체없이 조치하겠습니다.
...
<개인정보처리자명>은(는) 개인정보의 안전성을 확보하기 위하여 법령에서 규정하고 있는 사항
이외에도 다음과 같은 활동을 시행하고 있습니다.
1. 개인정보보호 활동: 개인정보보호 관련 블로그·유튜브 운영, 투명성 보고서 발간(연 1회), 공동규제 및
자율규약 참여 현황, 자율규제단체 활동
2. 국내외 개인정보보호 인증 획득: ISO/IEC 27701, ISMS-P

7. 개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항
① <개인정보처리자명>은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를
...
가. 쿠키의 사용목적: 이용자의 로그인 여부를 확인하기 위하여 사용합니다.
나. 쿠키의 설치·운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다.
다. 쿠키 저장을 거부할 경우 로그인이 필요한 일부 서비스 이용에 제한이 생길 수 있습니다.

8. 행태정보의 수집·이용 및 거부 등에 관한 사항
① <개인정보처리자>은(는) 서비스 이용과정에서 정보주체에게 최적화된 맞춤형 서비스 및 혜택,
온라인 맞춤형 광고 등을 제공하기 위하여 행태정보를 수집·이용하고 있습니다.
② <개인정보처리자>은(는) 다음과 같이 행태정보를 수집합니다.
수집하는 행태정보의 항목 행태정보 수집 방법 행태정보 수집 목적
보유·이용기간 및
이후 정보처리 방법
• 이용자의 웹사이트/앱
서비스 방문이력,
...
9. 개인정보 보호책임자
① <개인정보처리자명>은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와
...
담당자 : ○○○
연락처 : <전화번호>, <이메일>, <팩스번호>
② 정보주체는 <개인정보처리자명>의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보보호
관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의할 수
있습니다. <개인정보처리자명> 은(는) 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것입니다.
...
② <개인정보처리자명>은(는) 정보주체의 개인정보자기결정권을 보장하고, 개인정보침해로 인한
